    ...
    <div className="bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden fade-in">
      ...
      >
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="text-xs text-gray-400 capitalize">{venue.capacity}</span>
        </div>
      </div>
